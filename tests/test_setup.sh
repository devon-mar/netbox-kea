...
openssl req -new -newkey rsa:2048 -sha256 -days 365 -nodes -x509 -keyout ./tests/docker/certs/ca.key -out ./tests/docker/certs/ca.crt -addext "basicConstraints=critical,CA:true" -addext "keyUsage=critical,keyCertSign" -subj "/CN=Test CA"
